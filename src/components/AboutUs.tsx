        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          <div className="bg-white p-8 md:p-14 border border-slate-100 rounded-[2.5rem] shadow-sm max-w-4xl mx-auto space-y-6">
            ...
            <p className="text-slate-600 max-w-2xl mx-auto leading-relaxed text-sm md:text-base font-medium">
              AsaanSafar is directed by an exceptional group of transit experts, developers, and field leaders under the guidance of our CEO & Founder <strong>Mujahid Ali</strong> and General Manager <strong> </strong>.
            </p>
            <div className="pt-4">
              <button
