...
export const MOCK_BLOGS: BlogPost[] = [
  {
    ...
    excerpt: "If you've ever traveled by a non-AC bus in Pakistan, you probably know that every journey is different. Learn how to verify timetables, understand routes, compare fares, and travel stress-free anywhere in Pakistan.",
    ...
    sections: [
      {
        type: "paragraph",
        text: "If you've ever traveled by a non-AC bus in Pakistan, you probably know that every journey is different. Some buses leave exactly on time, while others may arrive late or follow a slightly different route than expected. That's why spending a few minutes checking the details before your trip can make a big difference."
      },
      {
        type: "paragraph",
        text: "Whether you're traveling for work, university, business, or to visit family, choosing the right bus service can help you avoid unnecessary delays and make your journey much more comfortable."
      },
      {
        type: "paragraph",
        text: "In this guide, we'll share some simple tips that can help you choose a reliable non-AC bus service anywhere in Pakistan."
      },
      {
        type: "heading",
        text: "Why Choosing the Right Bus Matters"
      },
      {
        type: "paragraph",
        text: "When people compare buses, the first thing they usually look at is the fare. While ticket price is important, it's not the only factor worth considering."
      },
      {
        type: "paragraph",
        text: "A reliable bus service offers something even more valuable—peace of mind. You know when the bus is expected to leave, where it will stop, and what to expect during your journey."
      },
      {
        type: "paragraph",
        text: "Good travel planning helps you:"
      },
      {
        type: "list",
        items: [
          ...
          "Plan connecting travel more easily",
          "Reduce last-minute stress",
          "Reach your destination with greater confidence"
        ]
      },
      {
        type: "paragraph",
        text: "A little preparation before leaving home often makes the entire trip smoother."
      },
      {
        type: "heading",
        text: "Always Confirm the Latest Bus Timings"
      },
      {
        type: "paragraph",
        text: "One of the biggest mistakes travelers make is relying on old schedules."
      },
      {
        type: "paragraph",
        text: "Bus timings can change because of road conditions, weather, operational requirements, public holidays, or seasonal demand. A schedule that was correct last month may not be accurate today."
      },
      {
        type: "paragraph",
        text: "Before starting your journey, try to confirm:"
      },
      {
        type: "list",
        items: [
          ...
          "Boarding location",
          "Route information",
          "Bus operator's contact number"
        ]
      },
      {
        type: "paragraph",
        text: "Taking a minute to verify these details can save hours of inconvenience later."
      },
      {
        type: "heading",
        text: "Check the Route Before Booking"
      },
      {
        type: "paragraph",
        text: "Two buses traveling between the same cities don't always follow the same road."
      },
      {
        type: "paragraph",
        text: "Some operators take the shortest route, while others stop at several towns, bus terminals, or smaller cities along the way. These additional stops can increase the total travel time."
      },
      {
        type: "paragraph",
        text: "For example, if you're traveling from Lahore to Faisalabad, one bus may travel almost directly, while another may pass through several intermediate locations before reaching its destination."
      },
      {
        type: "paragraph",
        text: "Before choosing a bus, look at:"
      },
      {
        type: "list",
        items: [
      ...
      {
        type: "paragraph",
        text: "Understanding the route helps you select the option that best matches your schedule."
      },
      {
        type: "heading",
        text: "Choose an Operator with a Good Reputation"
      },
      {
        type: "paragraph",
        text: "Not every bus company provides the same level of service."
      },
      {
        type: "paragraph",
        text: "Experienced travelers often prefer operators that are known for maintaining regular schedules, sharing accurate information, and offering dependable service."
      },
      {
        type: "paragraph",
        text: "If you're traveling on a route for the first time, don't hesitate to ask friends, relatives, or frequent travelers for recommendations. Their experiences can give you a better idea of what to expect."
      },
      {
        type: "paragraph",
        text: "While no service is perfect every day, operators with a good reputation are generally more consistent."
      },
      {
        type: "heading",
        text: "Compare Fares—But Don't Focus Only on Price"
      },
      {
        type: "paragraph",
        text: "Non-AC buses are already one of the most affordable ways to travel in Pakistan, but fares can still vary between operators."
      },
      {
        type: "paragraph",
        text: "Before making your decision:"
      },
      {
        type: "list",
        items: [
          ...
          "Ask if prices have recently changed",
          "Make sure you're comparing similar routes"
        ]
      },
      {
        type: "paragraph",
        text: "The cheapest option isn't always the best one. Sometimes paying a little extra is worthwhile if it means fewer delays and a more reliable journey."
      },
      {
        type: "heading",
        text: "Save the Bus Operator's Contact Number"
      },
      {
        type: "paragraph",
        text: "This is a small step that many travelers overlook."
      },
      {
        type: "paragraph",
        text: "Having the operator's phone number allows you to quickly confirm departure times, ask about delays, verify the boarding point, or get updates if your travel plans change."
      },
      {
        type: "paragraph",
        text: "It's much easier to make a quick phone call than to arrive at the terminal only to discover that the schedule has changed."
      },
      {
        type: "heading",
        text: "Reach the Bus Terminal Early"
      },
      {
        type: "paragraph",
        text: "Even if your departure time has been confirmed, arriving early is always a smart idea."
      },
      {
        type: "paragraph",
        text: "Unexpected traffic, parking issues, or busy terminals can easily delay your arrival."
      },
      {
        type: "paragraph",
      ...
      },
      {
        type: "list",
        items: [
          "Reach the terminal 15 to 30 minutes early for shorter routes.",
          "Arrive around 30 to 45 minutes early for longer journeys."
        ]
      },
      {
        type: "paragraph",
        text: "This gives you enough time to locate your bus, confirm your seat if necessary, and board without rushing."
      },
      {
        type: "heading",
        text: "Make Safety Part of Your Travel Plan"
      },
      {
        type: "paragraph",
        text: "A comfortable journey also depends on staying safe."
      },
      {
        type: "paragraph",
        text: "Before boarding, remember to:"
      },
      {
        type: "list",
        items: [
          "Keep your valuables secure.",
          "Carry any necessary identification.",
          "Let someone know about your travel plans.",
          "Save important contact numbers on your phone."
        ]
      },
      {
        type: "paragraph",
        text: "If a bus appears overcrowded or doesn't seem safe, waiting for another service is often the better choice."
      },
      {
        type: "heading",
      ...
      {
        type: "paragraph",
        text: "Many travel problems happen because of simple oversights."
      },
      {
        type: "paragraph",
        text: "Here are a few mistakes worth avoiding:"
      },
      {
        type: "list",
        items: [
          "Depending on outdated schedules",
          "Arriving at the last minute",
          "Ignoring the complete route",
          "Forgetting to save the operator's contact number",
          "Choosing a bus based only on the lowest fare"
        ]
      },
      {
        type: "paragraph",
        text: "A few minutes of preparation can help you avoid hours of inconvenience."
      },
      {
        type: "heading",
        text: "Why Verified Bus Information Matters"
      },
      {
        type: "paragraph",
        text: "Planning a trip becomes much easier when you have access to reliable information."
      },
      {
        type: "paragraph",
        text: "Unfortunately, many passengers still depend on unofficial sources or outdated schedules, which can lead to confusion and unexpected delays."
      },
      {
        type: "paragraph",
        text: "Verified information allows travelers to:"
      },
      {
        type: "list",
        items: [
      ...
      {
        type: "paragraph",
        text: "The more accurate your information is, the easier your journey becomes."
      },
      {
        type: "heading",
      ...
      {
        type: "paragraph",
        text: "Finding trustworthy information about non-AC buses isn't always easy. That's why AsaanSafar was created."
      },
      {
        type: "paragraph",
        text: "Our goal is to help travelers across Pakistan access verified information before they begin their journey."
      },
      {
        type: "paragraph",
        text: "On AsaanSafar, you can find:"
      },
      {
        type: "list",
        items: [
      ...
      {
        type: "paragraph",
        text: "We regularly review and update our information so travelers can plan their trips with greater confidence."
      },
      {
        type: "paragraph",
        text: "Whether you're traveling occasionally or every week, having accurate information before you leave can make your journey much more predictable."
      },
      {
        type: "heading",
        text: "Final Thoughts"
      ...
      {
        type: "paragraph",
        text: "Choosing a reliable non-AC bus service isn't just about finding the lowest ticket price. It's about selecting a service that fits your schedule, provides accurate information, and helps you travel with confidence."
      },
      {
        type: "paragraph",
        text: "Before every trip, take a few minutes to verify the timing, check the route, compare fares, and save the operator's contact details. These simple habits can prevent many common travel problems."
      },
      {
        type: "paragraph",
        text: "Wherever your journey takes you, good planning is the first step toward a smoother travel experience. And with verified bus information from AsaanSafar, planning that journey becomes a little easier."
      },
      {
        type: "heading",
      ...
      {
        type: "paragraph",
        text: "پاکستان میں نان اے سی بس کے ذریعے سفر کرنا لاکھوں لوگوں کی روزمرہ زندگی کا حصہ ہے۔ چاہے آپ ملازمت کے لیے سفر کر رہے ہوں، کالج یا یونیورسٹی جا رہے ہوں، کاروباری کام ہو یا اپنے عزیزوں سے ملنے جا رہے ہوں، نان اے سی بسیں آج بھی ملک کے مختلف شہروں کے درمیان سفر کا ایک سستا اور آسان ذریعہ ہیں۔"
      },
      {
        type: "paragraph",
        text: "لیکن ہر بس سروس ایک جیسی نہیں ہوتی۔ کچھ آپریٹرز وقت کی پابندی کرتے ہیں، جبکہ بعض اوقات کچھ بسوں کے اوقات، کرایے یا روٹس میں تبدیلی آ جاتی ہے۔ اسی لیے سفر سے پہلے چند منٹ تحقیق کرنے سے آپ کا وقت بھی بچ سکتا ہے اور غیر ضروری پریشانی سے بھی بچا جا سکتا ہے۔"
      },
      {
        type: "paragraph",
        text: "آئیے دیکھتے ہیں کہ ایک قابلِ اعتماد نان اے سی بس سروس کا انتخاب کرتے وقت کن باتوں کا خیال رکھنا چاہیے۔"
      },
      {
        type: "heading",
      ...
      {
        type: "paragraph",
        text: "اکثر لوگ بس کا انتخاب صرف کرائے کو دیکھ کر کرتے ہیں، لیکن اچھی بس سروس صرف کم کرائے کا نام نہیں۔"
      },
      {
        type: "paragraph",
        text: "ایک قابلِ اعتماد بس سروس آپ کو بروقت روانگی، واضح معلومات اور نسبتاً پرسکون سفر فراہم کرتی ہے۔ جب آپ کو پہلے سے معلوم ہو کہ بس کب روانہ ہوگی، کس راستے سے جائے گی اور تقریباً کب منزل پر پہنچے گی، تو پورا سفر زیادہ منظم محسوس ہوتا ہے۔"
      },
      {
        type: "paragraph",
        text: "صحیح بس سروس منتخب کرنے کے فوائد یہ ہیں:"
      },
      {
        type: "list",
        items: [
          "وقت کی بچت ہوتی ہے۔",
          "غیر ضروری انتظار سے بچ جاتے ہیں۔",
          "اگلے سفر کی بہتر منصوبہ بندی کی جا سکتی ہے۔",
          "آخری وقت کی پریشانی کم ہو جاتی ہے۔",
          "سفر زیادہ پُراعتماد انداز میں مکمل ہوتا ہے۔"
        ]
      },
      {
        type: "heading",
        text: "سفر سے پہلے بس کے اوقات ضرور چیک کریں"
      },
      {
        type: "paragraph",
        text: "یہ ایک عام غلطی ہے کہ لوگ پرانے اوقات پر اعتماد کر لیتے ہیں۔"
      },
      {
        type: "paragraph",
        text: "حقیقت یہ ہے کہ بسوں کے اوقات ٹریفک، موسم، سڑکوں کی مرمت، عوامی تعطیلات یا آپریشنل وجوہات کی وجہ سے تبدیل ہو سکتے ہیں۔"
      },
      {
        type: "paragraph",
        text: "گھر سے نکلنے سے پہلے یہ معلومات ضرور تصدیق کریں:"
      },
      {
        type: "list",
        items: [
      ...
      {
        type: "paragraph",
        text: "صرف چند منٹ کی تصدیق آپ کو کئی گھنٹوں کی پریشانی سے بچا سکتی ہے۔"
      },
      {
        type: "heading",
        text: "صرف منزل نہیں، روٹ بھی دیکھیں"
      },
      {
        type: "paragraph",
        text: "ایک ہی شہر کے درمیان چلنے والی تمام بسیں ایک ہی راستہ اختیار نہیں کرتیں۔"
      },
      {
        type: "paragraph",
        text: "کچھ بسیں سیدھا سفر کرتی ہیں، جبکہ بعض مختلف شہروں اور قصبوں سے گزرتی ہیں۔ زیادہ اسٹاپ ہونے کی وجہ سے سفر کا دورانیہ کافی بڑھ سکتا ہے۔"
      },
      {
        type: "paragraph",
        text: "مثال کے طور پر، لاہور سے فیصل آباد جانے والی ایک بس براہِ راست جا سکتی ہے، جبکہ دوسری بس راستے میں کئی شہروں پر رکتی ہوئی منزل تک پہنچتی ہے۔"
      },
      {
        type: "paragraph",
        text: "بس منتخب کرتے وقت یہ ضرور دیکھیں:"
      },
      {
        type: "list",
        items: [
      ...
      {
        type: "paragraph",
        text: "اس سے آپ اپنی ضرورت کے مطابق بہتر فیصلہ کر سکتے ہیں۔"
      },
      {
        type: "heading",
        text: "اچھی شہرت رکھنے والے بس آپریٹر کو ترجیح دیں"
      },
      {
        type: "paragraph",
        text: "کسی بھی بس کمپنی کی ساکھ اس کی سروس کے بارے میں کافی کچھ بتا دیتی ہے۔"
      },
      {
        type: "paragraph",
        text: "قابلِ اعتماد آپریٹر عموماً:"
      },
      {
        type: "list",
        items: [
          "مقررہ اوقات کی پابندی کرتے ہیں۔",
          "درست معلومات فراہم کرتے ہیں۔",
          "اپنی سروس میں تسلسل رکھتے ہیں۔",
          "اہم تبدیلیوں کی اطلاع دینے کی کوشش کرتے ہیں۔",
          "مسافروں کی رہنمائی کے لیے رابطے میں رہتے ہیں۔"
        ]
      },
      {
        type: "paragraph",
        text: "اگر آپ کسی روٹ پر پہلی بار سفر کر رہے ہیں تو دوستوں، رشتہ داروں یا باقاعدہ سفر کرنے والے افراد سے مشورہ لینا بھی مفید ثابت ہو سکتا ہے۔"
      },
      {
        type: "heading",
        text: "صرف کم کرائے کو بنیاد نہ بنائیں"
      },
      {
        type: "paragraph",
        text: "نان اے سی بسیں پہلے ہی نسبتاً کم خرچ سفر کا ذریعہ ہیں، لیکن مختلف کمپنیوں کے کرایوں میں فرق ہو سکتا ہے۔"
      },
      {
        type: "paragraph",
        text: "سفر سے پہلے:"
      },
      {
        type: "list",
        items: [
          "مختلف کمپنیوں کے کرائے دیکھیں۔",
          "تازہ ترین کرایہ معلوم کریں۔",
          "اگر حال ہی میں کرایہ تبدیل ہوا ہو تو اس کی تصدیق کریں۔",
          "ایک جیسے روٹس کا آپس میں موازنہ کریں۔"
        ]
      },
      {
        type: "paragraph",
        text: "کبھی کبھی تھوڑا زیادہ کرایہ دے کر بہتر اور زیادہ قابلِ اعتماد سروس حاصل کرنا زیادہ فائدہ مند ثابت ہوتا ہے۔"
      },
      {
        type: "heading",
        text: "بس کمپنی کا رابطہ نمبر محفوظ رکھیں"
      },
      {
        type: "paragraph",
        text: "یہ ایک چھوٹی سی عادت ہے لیکن بہت مفید ثابت ہوتی ہے۔"
      },
      {
        type: "paragraph",
        text: "اگر آپ کے پاس کمپنی کا رابطہ نمبر موجود ہو تو آپ آسانی سے:"
      },
      {
        type: "list",
        items: [
          "روانگی کا وقت معلوم کر سکتے ہیں۔",
          "تاخیر کی صورت میں معلومات حاصل کر سکتے ہیں۔",
          "درست بس اسٹینڈ کی تصدیق کر سکتے ہیں۔",
          "سفر سے متعلق سوالات پوچھ سکتے ہیں۔"
        ]
      },
      {
        type: "paragraph",
        text: "ایک مختصر فون کال کئی غیر ضروری مشکلات سے بچا سکتی ہے۔"
      },
      {
        type: "heading",
        text: "بس اڈے پر وقت سے پہلے پہنچیں"
      },
      {
        type: "paragraph",
        text: "اگرچہ آپ نے بس کے اوقات کی تصدیق کر لی ہو، پھر بھی بہتر یہی ہے کہ مقررہ وقت سے پہلے بس اڈے پہنچ جائیں۔"
      },
      {
        type: "paragraph",
        text: "ٹریفک، رش یا پارکنگ جیسے مسائل کبھی بھی پیش آ سکتے ہیں۔"
      },
      {
        type: "paragraph",
        text: "عام طور پر:"
      },
      {
        type: "list",
        items: [
          "قریبی سفر کے لیے 15 سے 30 منٹ پہلے پہنچیں۔",
          "طویل سفر کے لیے 30 سے 45 منٹ پہلے پہنچنا بہتر رہتا ہے۔"
        ]
      },
      {
        type: "paragraph",
        text: "اس سے آپ آرام سے اپنی بس تلاش کر سکتے ہیں اور بغیر جلدی کے سوار ہو سکتے ہیں۔"
      },
      {
        type: "heading",
        text: "سفر کے دوران حفاظت کو اولین ترجیح دیں"
      },
      {
        type: "paragraph",
        text: "آرام دہ سفر کے ساتھ محفوظ سفر بھی اتنا ہی ضروری ہے۔"
      },
      {
        type: "paragraph",
        text: "روانگی سے پہلے:"
      },
      {
        type: "list",
        items: [
          "اپنی قیمتی اشیاء محفوظ رکھیں۔",
          "ضروری شناختی دستاویز ساتھ رکھیں۔",
          "گھر والوں کو اپنے سفر کی اطلاع دیں۔",
          "اہم رابطہ نمبرز موبائل میں محفوظ رکھیں۔"
        ]
      },
      {
        type: "paragraph",
        text: "اگر کسی بس کی حالت غیر محفوظ محسوس ہو یا غیر معمولی رش ہو تو بہتر ہے کہ اگلی مناسب بس کا انتظار کریں۔"
      },
      {
        type: "heading",
        text: "چند عام غلطیاں جن سے بچنا چاہیے"
      },
      {
        type: "paragraph",
        text: "اکثر سفری مسائل چند عام غلطیوں کی وجہ سے پیش آتے ہیں، جیسے:"
      },
      {
        type: "list",
        items: [
          "پرانے شیڈول پر اعتماد کرنا۔",
          "آخری وقت پر بس اڈے پہنچنا۔",
          "مکمل روٹ معلوم نہ کرنا۔",
          "کمپنی کا رابطہ نمبر محفوظ نہ کرنا۔",
          "صرف کم کرایہ دیکھ کر فیصلہ کرنا۔"
        ]
      },
      {
        type: "paragraph",
        text: "اگر آپ ان غلطیوں سے بچ جائیں تو آپ کا سفر کافی آسان اور بہتر ہو سکتا ہے۔"
      },
      {
        type: "heading",
        text: "درست معلومات کی اہمیت"
      },
      {
        type: "paragraph",
        text: "آج کے دور میں کامیاب سفر کی بنیاد درست معلومات ہیں۔"
      },
      {
        type: "paragraph",
        text: "بدقسمتی سے بہت سے لوگ اب بھی غیر مصدقہ ذرائع یا پرانی معلومات پر انحصار کرتے ہیں، جس سے وقت ضائع ہونے اور پریشانی کا سامنا کرنا پڑ سکتا ہے۔"
      },
      {
        type: "paragraph",
        text: "درست اور تصدیق شدہ معلومات آپ کو:"
      },
      {
        type: "list",
        items: [
          "وقت بچانے میں مدد دیتی ہیں۔",
          "مختلف آپشنز کا موازنہ کرنے کا موقع دیتی ہیں۔",
          "بہتر منصوبہ بندی میں مدد کرتی ہیں۔",
          "غیر یقینی صورتحال کم کرتی ہیں۔",
          "اعتماد کے ساتھ سفر کا فیصلہ کرنے میں معاون ثابت ہوتی ہیں۔"
        ]
      },
      {
        type: "heading",
        text: "AsaanSafar مسافروں کی کیسے مدد کرتا ہے؟"
      },
      {
        type: "paragraph",
        text: "AsaanSafar کا مقصد پاکستان بھر کے مسافروں کو نان اے سی بسوں کی قابلِ اعتماد اور تصدیق شدہ معلومات ایک ہی جگہ فراہم کرنا ہے۔"
      },
      {
        type: "paragraph",
        text: "ہماری ویب سائٹ پر آپ کو مل سکتی ہیں:"
      },
      {
        type: "list",
        items: [
          "تصدیق شدہ بس ٹائمنگ",
          "روانگی اور پہنچنے کے اوقات",
          "کرایے کی معلومات",
          "بس کمپنی کی تفصیلات",
          "رابطہ نمبرز",
          "روٹ کی معلومات"
      ...
      {
        type: "paragraph",
        text: "ہم کوشش کرتے ہیں کہ معلومات کو وقتاً فوقتاً اپڈیٹ کیا جائے تاکہ مسافر زیادہ اعتماد کے ساتھ اپنے سفر کی منصوبہ بندی کر سکیں۔"
      },
      {
        type: "heading",
        text: "اختتامی بات"
      ...
      {
        type: "paragraph",
        text: "ایک اچھی نان اے سی بس سروس کا انتخاب صرف کم کرایہ تلاش کرنے کا نام نہیں، بلکہ درست معلومات، مناسب روٹ اور قابلِ اعتماد سروس کو ترجیح دینا بھی ضروری ہے۔"
      },
      {
        type: "paragraph",
        text: "اگر آپ ہر سفر سے پہلے چند منٹ نکال کر بس کے اوقات، روٹ، کرایہ اور رابطہ نمبر کی تصدیق کر لیں تو آپ بہت سی عام مشکلات سے بچ سکتے ہیں۔"
      },
      {
        type: "paragraph",
        text: "چاہے آپ کسی بھی مقصد کے لیے سفر کر رہے ہوں، اچھی منصوبہ بندی ہمیشہ بہتر سفر کی ضمانت بنتی ہے۔ اور AsaanSafar کا مقصد بھی یہی ہے کہ پاکستان کے ہر مسافر کو درست اور قابلِ اعتماد معلومات فراہم کی جائیں تاکہ ہر سفر زیادہ آسان، محفوظ اور پُراعتماد بن سکے۔"
      }
    ],
    keyTakeaway: "Choosing a reliable non-AC bus service involves comparing fares, checking the bus operator's reputation, verifying the route and timings, and saving their contact number. A few minutes of preparation with AsaanSafar guarantees a stress-free and smooth journey across Pakistan."
  },
  {
    id: 2,
